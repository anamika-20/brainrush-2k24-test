...
const Question = ({ question, currentQuestion, totalQuestions, onNext, onPrev, handleClick, clickedIndex }) => {
    return (
        <>
         ...
         `}
            ...
            <div className="flex justify-between mt-[22px]  space-x-4">
                <button onClick={onPrev} className="flex items-center justify-center border border-gray-300 py-2 px-4 rounded-md w-full">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                ...
                <button onClick={onNext} className="flex items-center justify-center border border-background bg-background text-white py-2 px-4 rounded-md w-full">
                    Next
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        className="h-5 w-5 ml-2"
